...
$lang['admin.add_edit.page.children'] = 'Вложенные страницы';
$lang['admin.add_edit.page.children.description'] = '';
...
$lang['admin.calendar'] = 'Календарь резерваций';
...
$lang['admin.entity_list.apartmentreserv.day_in_day'] = 'День в день';
...
$lang['admin.add_edit.apartmentreserv.day_in_day'] = 'День в день';
$lang['admin.add_edit.apartmentreserv.day_in_day.description'] = '';
...
$lang['admin.entity_list.reservation.filter.apartment.id_title'] = 'Обьект';
$lang['admin.entity_list.reservation.filter.date_from_title'] = 'Заезд';
$lang['admin.entity_list.reservation.filter.created_at_title'] = 'Дата заказа';
$lang['admin.entity_list.reservation.filter.is_published_title'] = 'Активен';

$lang['admin.search.reservation.description'] = 'По коду заказа';

$lang['admin.entity_list.reservation.code'] = 'Invoice Nr.';
$lang['admin.entity_list.reservation.apartment.street'] = 'Street';
$lang['admin.entity_list.reservation.apartment.id'] = 'Objekt ID';
$lang['admin.entity_list.reservation.date_from'] = 'from';
$lang['admin.entity_list.reservation.date_to'] = 'till';
$lang['admin.entity_list.reservation.persons'] = 'P';
$lang['admin.entity_list.reservation.added_person'] = 'EP';
$lang['admin.entity_list.reservation.utype'] = 'Booker';
$lang['admin.entity_list.reservation.name'] = 'Name';
$lang['admin.entity_list.reservation.surname'] = 'Surname';
$lang['admin.entity_list.reservation.phone'] = 'Phone';
$lang['admin.entity_list.reservation.email'] = 'E-mail';
$lang['admin.entity_list.reservation.time_h'] = 'arr.h';
$lang['admin.entity_list.reservation.time_m'] = 'arr.m';
$lang['admin.entity_list.reservation.total_cost_in'] = 'Price In';
$lang['admin.entity_list.reservation.total_cost'] = 'Price Out';
$lang['admin.entity_list.reservation.vat_summ'] = 'VAT';
$lang['admin.entity_list.reservation.transfer'] = 'Tr';
$lang['admin.entity_list.reservation.created_at'] = 'Created at';
$lang['admin.entity_list.reservation.payment_type'] = 'PT';
$lang['admin.entity_list.reservation.breakfast'] = 'Brkfst';

$lang['admin.printlist'] = 'Распечатать список';
$lang['admin.printlist.reservation.title'] = 'Печать списка заказов';

$lang['enum.reservation.payment_type.cash'] = 'cash';
$lang['enum.reservation.payment_type.bank'] = 'bank';
$lang['enum.reservation.payment_type.credit_card'] = 'cc';
$lang['enum.reservation.payment_type.credit_card_terminal'] = 'cct';

$lang['admin.add_edit.reservation.form_title'] = 'Добавить/изменить Заказ';
$lang['admin.add_edit.reservation.code'] = 'Номер заказа';
$lang['admin.add_edit.reservation.code.description'] = '';
$lang['admin.add_edit.reservation.is_published'] = 'Заказ активен';
$lang['admin.add_edit.reservation.is_published.description'] = '';
...
$lang['admin.add_edit.reservation.added_person'] = 'Доп. персона';
$lang['admin.add_edit.reservation.added_person.description'] = '';
...
$lang['admin.add_edit.reservation.vat_rate'] = 'НДС';
$lang['admin.add_edit.reservation.vat_rate.description'] = 'Для ФИЗ-лиц - оставте поле пустым';
$lang['admin.add_edit.reservation.payment_type'] = 'Метод платежа';
$lang['admin.add_edit.reservation.payment_type.description'] = '';
...
$lang['admin.add_edit.reservation.breakfast'] = 'Завтрак';
$lang['admin.add_edit.reservation.breakfast.description'] = '7 евро с человека за ночь';
...
$lang['admin.add_edit.reservation.total_cost_in'] = 'Общая стоимость (Вход)';
$lang['admin.add_edit.reservation.total_cost_in.description'] = 'ВНИМАНИЕ! ЕСЛИ ОСТАВИТЬ ПУСТЫМ - ПОСЧЕТАЕТСЯ АВТОМАТИЧЕСКИ ПОСЛЕ СОХРАНЕНИЯ';
$lang['admin.add_edit.reservation.total_cost'] = 'Общая стоимость (Выход)';
$lang['admin.add_edit.reservation.total_cost.description'] = 'ВНИМАНИЕ! ЕСЛИ ОСТАВИТЬ ПУСТЫМ - ПОСЧЕТАЕТСЯ АВТОМАТИЧЕСКИ ПОСЛЕ СОХРАНЕНИЯ';
...
$lang['admin.invoice_user'] = 'Inv_client';
$lang['admin.invoice_landlord'] = 'Inv_llord';
$lang['admin.invoice_bs'] = 'Inv_BSBT';
$lang['admin.invoice_email'] = 'Email';
$lang['admin.invoice_email_vaucher'] = 'Voucher Email';
$lang['admin.invoice_vaucher'] = 'Voucher Print';
...
$lang['admin.entity_list.apartment.filter.is_published_title'] = 'Опубликовано';
...
$lang['admin.add_edit.apartment.price_in'] = 'Цена в сутки для владельца';
$lang['admin.add_edit.apartment.price_in.description'] = '';
$lang['admin.add_edit.apartment.price_out'] = 'Цена в сутки для клиента';
...
$lang['admin.add_edit.apartment.add_person_in'] = 'Цена за доп. персону (для владельца)';
$lang['admin.add_edit.apartment.add_person_in.description'] = 'ЕСЛИ ОСТАВИТЬ ПУСТЫМ - ТО У ОБЬЕКТА НЕ БУДЕТ ВОЗМОЖНОСТИ ДОБАВЛЕНИЯ ДОП. ПЕРСОНЫ';
$lang['admin.add_edit.apartment.add_person_out'] = 'Цена за доп. персону (для клиента)';
$lang['admin.add_edit.apartment.add_person_out.description'] = 'ЕСЛИ ОСТАВИТЬ ПУСТЫМ - ТО У ОБЬЕКТА НЕ БУДЕТ ВОЗМОЖНОСТИ ДОБАВЛЕНИЯ ДОП. ПЕРСОНЫ';
...
$lang['admin.add_edit.apartment.c_name'] = 'Имя и фамилия контактного лица';
$lang['admin.add_edit.apartment.c_name.description'] = 'Например: Андрей Шевченко';
$lang['admin.add_edit.apartment.c_email'] = 'E-mail контактного лица';
$lang['admin.add_edit.apartment.c_email.description'] = '';
$lang['admin.add_edit.apartment.c_pr_phone'] = 'Основной телефон контактного лица';
$lang['admin.add_edit.apartment.c_pr_phone.description'] = 'В международном формате. Например: +380442322323';
$lang['admin.add_edit.apartment.c_sec_phone'] = 'Добавочный телефон контактного лица';
$lang['admin.add_edit.apartment.c_sec_phone.description'] = 'В международном формате. Например: +380442322323';
...
$lang['admin.add_edit.settings.home_page_seotext'] = 'Сеошный текст внизу страницы';
$lang['admin.add_edit.settings.home_page_seotext.description'] = '';


$lang['admin.settings.groups.apartments_page'] = 'Страница каталога обьектов';
$lang['admin.add_edit.settings.apartments_page_title'] = 'SEO заголовок';
$lang['admin.add_edit.settings.apartments_page_title.description'] = '';
$lang['admin.add_edit.settings.apartments_page_description'] = 'SEO описание';
$lang['admin.add_edit.settings.apartments_page_description.description'] = '';

$lang['admin.settings.groups.news_page'] = 'Страница новостей';
$lang['admin.add_edit.settings.news_page_title'] = 'SEO заголовок';
$lang['admin.add_edit.settings.news_page_title.description'] = '';
$lang['admin.add_edit.settings.news_page_description'] = 'SEO описание';
$lang['admin.add_edit.settings.news_page_description.description'] = '';
