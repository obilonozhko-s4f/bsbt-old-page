<table cellpadding="0" width="100%" cellspacing="0" border="0" style="margin: 0px;">
  <tr>
    <td align="right">
      <p style="font-size: 12px; line-height: 14px; font-style: italic; margin: 0;">
        Inh.O.Bilonozhko<br />
        Marienwerderstr.11<br />
        30823 Garbsen<br />
        www.bs-travelling.com<br />
        business@bs-travelling.com<br />
        Telefon: 0049 176 246 15 269<br />
        Fax: 0049 513 713 07 71
      </p>
    </td>
  </tr>
</table>

<table cellpadding="0" width="100%" cellspacing="0" border="0" style="margin: 20px 0;">
  <tr>
    <td align="left">
...
<table style="margin-top: 20px; margin-bottom: 30px; border: 0;" width="100%" cellpadding="0" cellspacing="0">
  <tr>
