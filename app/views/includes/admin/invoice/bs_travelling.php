...
<table cellpadding="0" width="100%" cellspacing="0" border="0" style="margin: 10px 0;">
  <tr>
    <td align="left">
      <p style="margin: 0;">Wohnung ID: <?=$info['apartment_id'];?></p>
    </td>
    <td align="right" style="vertical-align: top;">
      <p style="margin: 0;">Hannover, <?=$order['created_at'];?></p>
    </td>
  </tr>
</table>

<p style="margin: 0 0 15px 0;">VERBINDLICHE BUCHUNG(Keine Buchungsanfrage)</p>
<p style="margin: 0 0 5px 0; font-weight: bold;">Buchung Nr.: <?=$order['code'];?></p>
<p style="margin: 0 0 5px 0;">Gast:</p>
<p style="margin: 0 0 5px 0;"><?=$info['persons_arr_info'];?></p>
...
<p style="margin: 0;">Wohnung: <?=$info['apn_cost_in'];?> Euro</p>
<? if(isset($info['breakfast']) && $info['breakfast'] == TRUE):?>
  <p style="margin: 0;">Fr&uuml;hst&uuml;ck: <?=$info['br_cost_in'];?> Euro</p>
<? endif;?>
...
<table style="margin-top: 10px; border: 0;" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="right" width="100%" style="vertical-align: top;">
      <p style="width: 200px; padding-right: 15px;">Hannover, <?=$order['created_at'];?></p>
    </td>
  </tr>
</table>