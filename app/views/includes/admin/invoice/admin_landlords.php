...
<table cellpadding="0" width="100%" cellspacing="0" border="0" style="margin: 20px 0;">
  <tr>
    <td align="left">
      <p style="font-size: 10px; margin: 0; padding-left: 20px;">Biloonozhko.O. Marienwerderstr.11,30823 Garbsen</p>
      <p style="font-weight: bold; padding-left: 20px;"><?=$order['apartment']['landlord_name'];?><br />
