...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?=site_css("common/zero.css, style.css, jquery-ui-1.8.18.custom.css, jquery.stepper.css, jquery.lightbox-0.5.css");?>" />
  ...
  <script type="text/javascript" src="<?=site_js("jquery/jquery.bxSlider.min.js");?>"></script>
  <script type="text/javascript" src="<?=site_js("jquery/jquery.lightbox-0.5.js");?>"></script>
  <script type="text/javascript" src="<?=site_js("jquery/jquery.query.js");?>"></script>
...
<body>
    ...
    <div id="middle">
      <div id="left_part">
        <? $this->load->view("includes/parts/left_part"); ?>
      </div><!-- #left_part -->
		  <div id="content">
        <?=$content;?>
      </div><!-- #content -->
