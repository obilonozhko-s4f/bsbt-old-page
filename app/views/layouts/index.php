...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?=site_css("common/zero.css, style.css, jquery-ui-1.8.18.custom.css, nivo-slider.css, jquery.stepper.css");?>" />
  <script type="text/javascript" src="<?=site_js("jquery/jquery-1.7.1.min.js");?>"></script>
  <script type="text/javascript" src="<?=site_js("jquery/jquery.nivo.slider.js");?>"></script>
    ...
    <div id="middle">
      <div id="green">
        ...
        <div id="slider" class="nivoSlider">
          <img src="<?=site_img('slider1.jpg');?>" alt="" />
          <img src="<?=site_img('slider2.jpg');?>" alt="" />
          <img src="<?=site_img('slider3.jpg');?>" alt="" />
          <img src="<?=site_img('slider4.jpg');?>" alt="" />
        </div><!-- END slider -->
        <script type="text/javascript">
      ...
      <div id="left_part_index">
        <? $this->load->view("includes/parts/left_part_index"); ?>
      </div>
	  <div id="content_index">
	    <? $this->load->view("includes/parts/content_index"); ?>
      </div>
	  <div class="clear"></div>
	</div><!-- #middle -->
    <div id="footer">
