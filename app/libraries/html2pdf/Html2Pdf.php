...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(APPPATH . 'libraries/html2pdf/_class/exception.class.php');
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(0, 0, 0, 0))
        {
          
            if(is_array($orientation)){
              $langue = $orientation['langue'];
