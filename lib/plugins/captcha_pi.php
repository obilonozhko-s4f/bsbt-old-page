...
{		
   ...
   if ($word == '')
   {
		...
		$str = '';
		for ($i = 0; $i < $data['symbols_count']; $i++)
		{
	...
	$border_color	= imagecolorallocate ($im, 75, 135, 214);
	$text_color		= imagecolorallocate ($im, 75, 135, 214);
	$grid_color		= imagecolorallocate($im, 153, 197, 255);
	$shadow_color	= imagecolorallocate($im, 75, 135, 214);
