...
function &load_class($class, $instantiate = TRUE)
{
  ...
  // looking in base directoryss
  else if (file_exists(APPPATH.'libraries/common/'.config_item('subclass_prefix').$class.EXT))
  {
    require(BASEPATH.'libraries/'.$class.EXT);
		require(APPPATH.'libraries/common/'.config_item('subclass_prefix').$class.EXT);
		$is_subclass = TRUE;
  }
	else
	{
